...
const newCar1Price = (car1.finalPrice = car1.basePrice + newGlobalPrice);

const newCar2Price = (car2.finalPrice = car2.basePrice + newGlobalPrice);

console.log(`El primer coche vale: ${newCar1Price} `);
console.log(`El segundo coche vale: ${newCar2Price}`);
